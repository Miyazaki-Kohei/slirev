...
const PATTERNS: Pattern[] = [
  ...
  { id: "2", name: "セクション開始", category: "A. タイトル・セクション系", thumbnail_idx: 6 },
  { id: "3", name: "セクション終了・まとめ", category: "A. タイトル・セクション系", thumbnail_idx: 7 },
  { id: "4", name: "自己紹介", category: "A. タイトル・セクション系", thumbnail_idx: 5 },
  { id: "5", name: "クロージング", category: "A. タイトル・セクション系", thumbnail_idx: 8 },
  // B. カラムレイアウト系
  { id: "6", name: "2カラム比較", category: "B. カラムレイアウト系", thumbnail_idx: 10 },
  { id: "7a", name: "2カラム（テキスト＋画像）", category: "B. カラムレイアウト系", thumbnail_idx: 11 },
  { id: "7b", name: "2カラム（画像＋テキスト）", category: "B. カラムレイアウト系", thumbnail_idx: 12 },
  { id: "8", name: "3カラム（画像＋テキスト）", category: "B. カラムレイアウト系", thumbnail_idx: 13 },
  { id: "9", name: "3カラム（アクセントカラー付き）", category: "B. カラムレイアウト系", thumbnail_idx: 14 },
  { id: "10", name: "4カラムレイアウト", category: "B. カラムレイアウト系", thumbnail_idx: 15 },
  { id: "11", name: "5カラム（成熟度レベル）", category: "B. カラムレイアウト系", thumbnail_idx: 16 },
  { id: "12", name: "2x2グリッド（画像＋テキスト）", category: "B. カラムレイアウト系", thumbnail_idx: 17 },
  { id: "13", name: "2x3グリッドレイアウト", category: "B. カラムレイアウト系", thumbnail_idx: 18 },
  // C. 縦並びリスト系
  { id: "14", name: "縦3つステップ", category: "C. 縦並びリスト系", thumbnail_idx: 20 },
  { id: "15", name: "番号付きステップ（横型）", category: "C. 縦並びリスト系", thumbnail_idx: 21 },
  { id: "16", name: "タイムラインレイアウト", category: "C. 縦並びリスト系", thumbnail_idx: 22 },
  { id: "17", name: "アイコン付きリスト", category: "C. 縦並びリスト系", thumbnail_idx: 23 },
  // D. パネルデザイン系
  { id: "18", name: "基本パネル（画像ヘッダー付き）", category: "D. パネルデザイン系", thumbnail_idx: 25 },
  { id: "19", name: "強調パネル（左ボーダー付き）", category: "D. パネルデザイン系", thumbnail_idx: 26 },
  { id: "20", name: "ガラス風パネル", category: "D. パネルデザイン系", thumbnail_idx: 27 },
  { id: "21", name: "グラデーションパネル", category: "D. パネルデザイン系", thumbnail_idx: 28 },
  { id: "22", name: "カード型レイアウト（画像付き）", category: "D. パネルデザイン系", thumbnail_idx: 29 },
  // E. 背景・画像系
  { id: "23", name: "背景画像全画面", category: "E. 背景・画像系", thumbnail_idx: 31 },
